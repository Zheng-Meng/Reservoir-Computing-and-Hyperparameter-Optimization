...
- You can find the parameters tracking (extraction) achieved by reservoir computing on my [Github page](https://github.com/Zheng-Meng/Parameter-Tracking-with-Machine-Learning).
- Some tips:
