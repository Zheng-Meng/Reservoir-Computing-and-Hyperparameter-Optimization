...
- Some applications:
    - Find the **parameter aware reservoir computing** for collapse prediction of the food-chain, voltage, and spatial-temporal Kuramoto-Sivashinsky systems on [Github page](https://github.com/lw-kong/Reservoir_with_a_Parameter_Channel_PRR2021).
    - Find nonlinear **tracking control** achieved by reservoir comptuing with various chaotic and periodic trajectories examples on my [Github page](https://github.com/Zheng-Meng/TrackingControl).
    - Find **parameters tracking** by reservoir computing on my [Github page](https://github.com/Zheng-Meng/Parameter-Tracking-with-Machine-Learning).
    - Find **dyanmics reconstruction** by hybrid transformer and reservoir computing on my [Github page](https://github.com/Zheng-Meng/Dynamics-Reconstruction-ML).
- Some tips:
    ...
    - During hyperparameter optimization, consider setting a shorter prediction length initially with a broader range of hyperparameters. After the initial optimization, in the second round, you can opt for a longer prediction length and narrow down the hyperparameters, focusing around the hyperparameter values obtained in the last round.
