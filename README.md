...
- Some applications:
    ...
    - Find the nonlinear **tracking control** achieved by reservoir comptuing with various chaotic and periodic trajectories examples on my [Github page](https://github.com/Zheng-Meng/TrackingControl).
    - Find the **parameters tracking** by reservoir computing on my [Github page](https://github.com/Zheng-Meng/Parameter-Tracking-with-Machine-Learning).
    - Find the **dyanmics reconstruction** on my [Github page](https://github.com/Zheng-Meng/Dynamics-Reconstruction-ML).
- Some tips:
