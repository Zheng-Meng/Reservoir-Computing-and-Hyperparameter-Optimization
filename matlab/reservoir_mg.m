...
addpath('funcs\')
% we use Mackey-Glass (MG) system as an example of machine learning short- 
% and long-term prediction tasks 
...
% plot MG time series data
figure();
plot_length = 2000;
plot(data(1:plot_length, 1));
title('Mackey-Glass system time series')
ylabel('x')

% plot attractor
figure();
plot_length_long = 10000;
plot(ts_train(1:plot_length_long-tau, 1), ts_train(tau+1:plot_length_long, 1), 'r-');
title('Mackey-Glass system attractor');
...
legend('real', 'prediction')
title('Mackey-Glass system long term prediction')
